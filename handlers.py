...
PRICES = [
    LabeledPrice(label='PS4', amount=1500000),
    LabeledPrice(label='Прочная упаковка', amount=20000)
]
...
POST_SHIPPING_OPTION.add(LabeledPrice('Кортонная коробка', 50000))
POST_SHIPPING_OPTION.add(LabeledPrice('Срочное отправление!', 25000))

PICKUP_SHIPPING_OPTION = ShippingOption(
    id='pickup',
    title='Самовывоз'
)
PICKUP_SHIPPING_OPTION.add(LabeledPrice('Самовывоз в Сантк-Петербурге', 0))
